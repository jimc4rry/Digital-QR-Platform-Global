...
if not DEBUG:
    ...
    # Overridable so CI can run with DEBUG=False (to catch other production-only
    # issues) without every test request 301-redirecting - Django's test client
    # doesn't simulate HTTPS, so this would otherwise break plain-HTTP test requests.
